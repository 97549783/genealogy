...
with header_left:
    ...
    st.caption(
        "Платформа для построения деревьев научного руководства, поиска и сравнения диссертаций по содержательным и формальным критериям. В настоящий момент основу базы данных составляют диссертационные исследования по педагогическим наукам с 1995 года."
    )
with header_right:
    feedback_button()
