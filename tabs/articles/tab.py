"""Вкладка Streamlit для сравнения научных школ по публикациям.

Модуль содержит логику интерфейса: подготовку выбора школ, гидратацию
параметров запроса, запуск анализа, визуализацию и экспорт результатов.
"""
